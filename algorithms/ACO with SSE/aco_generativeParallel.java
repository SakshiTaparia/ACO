...
public class aco_generativeParallel
{
    ...
    public static void main(String[] args)
    {
        ...
        // }
        // csvReader.close();
        // System.out.println("Parsed Density.csv");
        ...
        BufferedReader csvReader = new BufferedReader(new FileReader("Junction.csv"));
        while ((row = csvReader.readLine()) != null) 
        {
            if(counter == 0)
            {
        ...
        csvReader.close();
        System.out.println("Parsed Junction.csv");

        // parse distance file as int
        ...
        // }
        // csvReader.close();
        // System.out.println("Parsed Distance.csv");

        counter = 0;
        ArrayList<ArrayList<Float>> Coverage = new ArrayList<ArrayList<Float>>();
        csvReader = new BufferedReader(new FileReader("Coverage.csv"));
        while ((row = csvReader.readLine()) != null) 
        {
            if(counter == 0)
            {
        ...
        csvReader.close();
        System.out.println("Parsed Coverage.csv");
        ...
        float [][] coverage = FloatList_to_floatArray(Coverage);
        // Density = null;
        Junction = null;
        Coverage = null;
        // Consider single RSU of Trange 243 metres

        // boolean[][] coverage = new boolean[distance.length][distance[0].length];
        ...
        ACO_parallel ACO = new ACO_parallel(junction, coverage);
        ACO.solve();
        }
